...
export function new_avoum_id(outpoint, index) {
...
export function makeBasicCell(amount, scriptHash) {
...
export function scriptAsJson(script) {
...
export async function makeInputCell(transactionHash, index) {
...
export async function createAssetCell(indexer, lockScriptCodeHash, lockScriptOutPoint) {
...
//               , ...
//               }
export const createCodeCells = async (indexer) => {
...
export const createCodeCell = async (indexer, path) => {
    await syncIndexer(indexer)
